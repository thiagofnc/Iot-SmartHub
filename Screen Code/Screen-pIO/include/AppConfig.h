...
constexpr char WIFI_SSID[] = "RHIT-OPEN";
constexpr char WIFI_PASSWORD[] = "";
constexpr char OPENWEATHER_API_KEY[] = "";
constexpr char OPENWEATHER_LOCATION[] = "Terre Haute,IN";
...
constexpr char SPOTIFY_CLIENT_ID[] = "";
constexpr char SPOTIFY_CLIENT_SECRET[] = "";
constexpr char SPOTIFY_REFRESH_TOKEN[] = "";
...
constexpr char FOOTBALLDATA_API_KEY[] = "";